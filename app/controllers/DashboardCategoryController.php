...
class DashboardCategoryController extends PaperClipDashboardModelManagementController {
	...
	{
		$input = array('category', 'language_id', 'description');
		$restoreTriggers = array('category');
	...
	{
		return $this->editStub($id, array('category', 'language_id', 'description'));
	}
	...
	public function update($id)
	{
		...
		$inputs = array('category', 'language_id', 'description');
		$restoreTriggers = array('category');
